package edu.designpattern.decorator4;
...
public class DecoratorStream {
	...
	static private void log(String string, Object o) {
		System.out.println(" : "+string +" : "+o.getClass().getSimpleName());
	}
...
//		LCD stream = new Authenticate( new Core() );
