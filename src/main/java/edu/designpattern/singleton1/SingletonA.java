 ...
 * 
 *
 *Якщо система розподілена, кожна JVM може мати свій екземляр Одинака. 
 *У EJB 3.1 з'явилась аннотація @Singleton,
 * яка забезпечує унікальність Одинака на різних JVM[2]
 */
//@Singleton
